package pduda.snake.manager.e2e;
    ...
    private static class TournamentOffice {
        public void canSeeApplicationHomePage() {
            ...
            try {
                ...
                assertEquals("Snake-Manager", appName);
            } finally {
                driver.quit();
            }
        }
        ...
        private String chromeDriverLocation() {
            ...
            if (!workDir.contains("manager-test-e2e")) {
                return "manager-test-e2e/src/test/resources/chromedriver";
            } else {
